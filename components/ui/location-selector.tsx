...
export function LocationSelector({
  ...
  useEffect(() => {
    const savedLocationData = localStorage.getItem("climateIQ-location");
  ...
  const handleLocationSelect = async (country: Country) => {
    ...
    localStorage.setItem("climateIQ-location", JSON.stringify(country));
...
export function getStoredLocation(): Country | null {
  ...
  try {
    const saved = localStorage.getItem("climateIQ-location");
